...
public class ThursdayFragment extends Fragment {
    ...
    String branch_name, sem_name ,day_name ="Thursday";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_thursday, null);
        listView = (ListView) view.findViewById(R.id.thursday_list_time_table);
        text = (TextView) view.findViewById(R.id.thursday_time_table_text);
