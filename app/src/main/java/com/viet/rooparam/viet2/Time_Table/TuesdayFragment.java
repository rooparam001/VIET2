...
public class TuesdayFragment extends Fragment {
    ...
    String branch_name, sem_name, day_name = "Tuesday";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_tuesday, null);
        listView = (ListView) view.findViewById(R.id.tuesday_list_time_table);
        text = (TextView) view.findViewById(R.id.tuesday_time_table_text);
