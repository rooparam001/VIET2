...
public class WednesdayFragment extends Fragment {
    ...
    String branch_name, sem_name ,day_name ="Wednesday";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_wednesday, null);
        listView = (ListView) view.findViewById(R.id.wednesday_list_time_table);
        text = (TextView) view.findViewById(R.id.wednesday_time_table_text);
